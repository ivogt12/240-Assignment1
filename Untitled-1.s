...
;  Date of last update: 2024-Jan-24
;  Files in this program: driver.c, average.asm, r.sh.  At a future date rg.sh may be added.
;  Testing: Alpha testing completed.  All functions are correct.
;  Status: Ready for release to customers
;
;Purpose
;  This program provides statistical driving information for drivers in the Orange County Area. 
;
;This file:
...
;  Prototype of this function: unsigned long average();
; 
;
;
;
...
name_string_size equ 48 ; stores user name size

title_string_size equ 48 ; stores user title !!should this be 48
